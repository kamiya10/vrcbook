              ...
              <div
                ...
                className={cn(
                  `
                    ...
                    acrylic:has-[[data-variant=inset]]:bg-transparent
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            `
              absolute inset-y-0 z-10 hidden h-full w-[--sidebar-width]
            ...
            variant === 'floating' || variant === 'inset'
              ? `
                ...
                group-data-[collapsible=icon]:pb-2
              `
              : `
                group-data-[collapsible=icon]:w-[--sidebar-width-icon]
    ...
    <Comp
      ...
      className={cn(
        `
          ...
          transition-[margin,opa] duration-200 ease-in-out
