...
import { getGalleryPrints } from '@/lib/api';

import type { File } from '@/lib/models/file';

const GalleryPrintsPage: React.FC = () => {
  ...
  useEffect(() => {
    void (async () => {
      setPrints(await getGalleryPrints());
    })();
  }, []);
...
GalleryPrintsPage.displayName = 'PrintsPage';

export default GalleryPrintsPage;
